...
核心要求（必须遵守）：
- 两人必须像真实聊天一样一问一答、互相回应，形成连续的对话链
- A说完B接话，B说完A再接，不能各说各的
- 每条消息就1-2句话，很短很碎，像在群里打字聊天
- 语气口语化、随意，像真人在群里对话
- 可以有调侃、吐槽、安慰、追问、共情、分享等真实互动
- 对话要有来有回，例如：A分享一件事 → B追问细节 → A继续说 → B表达反应

风格参考（非常重要）：
- 两人之间自然地接话，不是一个人在讲长篇大论
- 可以互相@对方说"你也这样吗"、"哈哈哈笑死"之类的
- 围观网友只是偶尔插嘴，反应要自然简短如"你俩好甜"、"然后呢"、"破防了"
- 网友评论不要太多，总共3-6条就够了
- 整体要有自然的聊天节奏，像两个人真的在群里聊起来了一样
{emoji_instruction}
{theme_line}
{reference_section}
...
[
  {{"speaker": "小明", "content": "今天遇到个超离谱的事"}},
  {{"speaker": "小红", "content": "？？？怎么了快说"}},
  {{"speaker": "小明", "content": "坐地铁忘刷卡，闸机一直响"}},
  {{"speaker": "小红", "content": "笑死，然后呢"}},
  {{"speaker": "阿杰", "content": "哈哈哈哈哈哈"}},
  {{"speaker": "小明", "content": "后面更绝，我直接翻过去了"}}
]
...
核心要求（必须遵守）：
- 两人必须像真实聊天一样一来一往、互诉心事，形成连续的情感对话
- 每条消息1-3句话，文字细腻、有画面感，像深夜里两个人在倾诉
- 语气温柔、克制，带着回忆和感慨的味道
- 对话要有来有回：A分享一段心情/回忆 → B给予回应/共鸣 → A继续 → B再回应
- 两人之间有默契、有试探、有欲言又止的感觉
- 整体像深夜电台的感觉，两个人慢慢聊开

风格参考（非常重要）：
- 两人之间自然地接话，可以分享彼此的心情、回忆、困扰、梦想
- 文字要有意境，善用比喻和意象，但保持聊天的自然感
- 围观网友偶尔插入简短评论如"看哭了"、"好温柔"等，不要太多
- 整体要有深夜聊天的氛围，节奏舒缓但有情感深度
{emoji_instruction}
{theme_line}
{reference_section}
总消息条数控制在 {min_msg} 到 {max_msg} 条之间。
...
[
  ...
  {{"speaker": "雨彤", "content": "什么的事？"}},
  {{"speaker": "林夕", "content": "大学时候的事了，那时候好像什么都不怕"}},
  {{"speaker": "雨彤", "content": "我懂，那种感觉...好像回不去了"}},
  {{"speaker": "夜猫子", "content": "你俩深夜好伤感"}},
  {{"speaker": "林夕", "content": "哈哈被发现了"}}
]
...
@register("astrbot_plugin_sadstory", "Towqs", "伪装聊天插件 - 以合并转发形式在群聊中展示伪装聊天", "0.5.9")
