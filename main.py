...
5. 【穿插引用】在互动时，你可以专门挑前面别人的一句话进行回复/吐槽。引用格式强烈推荐：「回复 某人：被引用的原文」 然后另起一行加上自己的回复。
6. 【呼应感】主角偶尔可以 @ 某个网友进行交互，或者说“你们别跟别人说”之类的，增加真实社群感。
...
4. 【穿插引用】两人在沟通时，或者网友在吃瓜时，可以主动引用前面的话来表现回复效果。例如采用：“「回复 某人：刚刚提及的话」 然后加上你现在的吐嘈”这种形式进行内容穿插。
5. 【群聊生态】围观网友偶尔插入简短评论如“笑死”、“你俩够了”、“大半夜的”，总共3-6条即可。
{emoji_instruction}{sticker_instruction}
{theme_line}
{reference_section}
总消息条数严格控制在 {min_msg} 到 {max_msg} 条之间。
...
@register("astrbot_plugin_sadstory", "Towqs", "伪装聊天插件 - 以合并转发形式在群聊中展示伪装聊天", "0.9.7")
