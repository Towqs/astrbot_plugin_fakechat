...
# 参考 https://github.com/kyubotics/coolq-http-api/wiki/表情-CQ-码-ID-表
FACE_MAP = {
    "流泪": 5, "哭": 5, "大哭": 9, "难过": 15, "委屈": 106,
    "心碎": 67, "伤心": 5, "痛哭": 9, "哭泣": 5,
    "叹气": 22, "无奈": 22, "叹息": 22, "唉": 22,
    "微笑": 14, "笑": 14, "偷笑": 12, "呲牙": 13, "笑哭": 182,
    "苦笑": 182, "尴尬": 10, "捂脸": 264,
    "抱抱": 49, "拥抱": 49,
    "加油": 53, "握手": 2,
    "沉默": 39, "沉思": 39, "思考": 39, "想": 39,
    "震惊": 0, "惊讶": 0, "吃惊": 0, "卧槽": 0,
    "发呆": 3, "呆": 3,
    "害怕": 26, "恐惧": 26,
    "生气": 11, "怒": 11, "愤怒": 11,
...
- 可用的表情：流泪、大哭、难过、委屈、心碎、叹气、无奈、微笑、偷笑、笑哭、苦笑、捂脸、抱抱、沉默、思考、震惊、发呆、害怕、生气、鼓掌、赞、玫瑰、凋谢、烟、啤酒、爱心、晕、睡、可怜
